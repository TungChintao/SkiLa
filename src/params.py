...
class TrainingArguments(HFTrainingArguments):
    ...
    # new params added for our Sketch-in-Latents
    sketch_lr: Optional[float] = None
    sketch_encoder: str = field(default="./")
    sketch_loss: str = field(default="mse")
    sketch_lambda: float = field(default=1e-1)
...
class DataArguments:
    ...
    sketch_token_num: int = field(default=4)
